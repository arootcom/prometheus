...
Команда получения данных из prom-master до prom-worker

```
 docker exec -it prom-master wget -qO- "http://docker.internal[]={job=\"local-apps\"}"
```

# Grafana

1. Откройте браузер и перейдите по адресу: `http://localhost:3000`
2. Введите стандартный логин и пароль по умолчанию: admin:admin
